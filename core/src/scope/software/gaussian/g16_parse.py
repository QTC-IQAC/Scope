    ...
    for idx, l in enumerate(ldx):
        ...
        for kdx in range(length):
            ...
            if witheigen:
                ...
                new_vnm.set_mode(atom_idx, atnum, x, y, z, is_mass_weighted=False)
            vnms.append(new_vnm)
            index += 1
    return vnms
    ...
    for idx, l in enumerate(ldx):
        ...
        if length > 3:
            ...
            if witheigen:
                ...
                new_vnm.set_mode(atom_idx, atnum, x, y, z, is_mass_weighted=False) # Gaussian's displacement vectors seem to be in Cartesian Coordinates
