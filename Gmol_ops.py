...
def gmol_update_geom(mol: object, name: str="coord", new_coord: list, debug: int=0) -> None:
...
def gmol_create_geom(mol: object, name: str="new_geom", new_coord: list, debug: int=0) -> None:
    setattr(mol,name,new_coord)
    for idx, at in enumerate(mol.atoms):
        setattr(at,name,new_coord[idx]

def cell_update_geom(cell: object, moleclist: list, name: str="pos", new_coord: list, debug: int=0) -> None:
...
def cell_create_geom(cell: object, moleclist: list, name: str="new_geom", new_coord: list, debug: int=0) -> None:
