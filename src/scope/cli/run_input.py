...
from scope.utils.run_input import run_input
...
def parse_args():
    parser = ArgumentParser(prog="scope_run_input", description="Runs an input for a given system")
...
def main():
    ...
    summary = ""
    report = run_input(args.sys_path, args.inp_path, args.env_path, handle_errors=args.errors, debug=debug)
